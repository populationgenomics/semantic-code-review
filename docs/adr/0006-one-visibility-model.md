...
- Status: Superseded by [0008](0008-hide-by-the-diff-fold-by-the-structure-label-by-meaning.md) (2026-09-07)
- Date: 2026-08-20

> Written and implemented on PR #11, which never merged; landed here from
> that branch, unchanged below this note, so the record is findable. ADR
> 0008 was written two weeks later without it and re-decided the same
> ground — see 0008 § *Relation to ADR 0006* for what it re-did, what it
> reversed, and what it restored afterwards. The status line above is the
> only edit.
