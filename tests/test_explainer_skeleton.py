...
def test_the_coverage_duty_sits_with_section_refs_not_with_the_map() -> None:
    ...
    it assigns to no section reaches no prose call at all. That duty binds
    the union of the three lists, which is a different claim from the Map's
    own rule about omitting a row."""
