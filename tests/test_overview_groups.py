    ...
    return AugmentedDiff(
        ...
        files=[
            FilePatch(
                ...
                hunks=[
                    Hunk(header="@@ -1,2 +1,2 @@", body="", old_start=1, old_count=2, new_start=1, new_count=2),
                    Hunk(header="@@ -10,2 +10,2 @@", body="", old_start=10, old_count=2, new_start=10, new_count=2),
                ],
            ),
            FilePatch(
                path="src/b.py",
                ...
                hunks=[
                    Hunk(header="@@ -1,3 +1,4 @@", body="", old_start=1, old_count=3, new_start=1, new_count=4),
                ],
            ),
        ],
    )
...
def test_viewer_json_no_groups() -> None:
    diff = _make_diff()
    apply_overview_to_diff(diff, {"summary": "", "files": []})
    payload = build_viewer_json(diff, meta={}, head_dir=None)
