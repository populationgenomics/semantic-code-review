...
def test_symbol_folding_snaps_method_under_class_and_drops_inner_block() -> None:
    ...
    rows = _rows_from_dicts(
        [
            ...
            {"kind": "ctx", "old_line": 3, "new_line": 3, "old_text": "        if x:", "new_text": "        if x:"},
            {
                "kind": "pair",
                "old_line": 4,
                "new_line": 4,
    ...
    spans = [
        {"start_line": 1, "end_line": 5, "kind": "class", "qualified_name": "Foo", "depth": 0},
        {"start_line": 2, "end_line": 5, "kind": "function", "qualified_name": "Foo.bar", "depth": 1},
    ]
...
@pytest.mark.parametrize(
    "case",
    json.loads(_FOLD_CASES_PATH.read_text(encoding="utf-8")),
    ids=lambda c: c["name"],
)
